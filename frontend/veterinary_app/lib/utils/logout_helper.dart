...
import '../main.dart';
import '../services/auth_services/token_service.dart'; // Assuming this is the login page to redirect to
            ...
            child: Column(
              ...
              children: [
                Icon(
                  ...
                  color: kPrimaryGreen, // Blue icon from app_colors.dart
                  size: 70, // Large icon
                ),
                ...
                Text(
                  ...
                  style: textTheme.headlineSmall?.copyWith(
                    color: kPrimaryGreen, // Blue title from app_colors.dart
                    ...
                    Expanded(
                      child: OutlinedButton(
                        ...
                        style: OutlinedButton.styleFrom(
                          foregroundColor: kPrimaryGreen, // From app_colors.dart
                          side: const BorderSide(color: kPrimaryGreen, width: 2), // From app_colors.dart
                        ...
                        child: Text(
                          'Cancel',
                          style: textTheme.labelLarge?.copyWith(color: kPrimaryGreen), // From app_colors.dart
                        ),
                      ),
                    ),
                    ...
                    Expanded(
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: kPrimaryGreen, // From app_colors.dart
